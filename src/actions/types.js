...
export const SPEND_FETCH_START = 'spend_fetch_start'
export const SPEND_FETCH_FINISHED = 'spend_fetch_finished'

//CATEGORY
export const CATEGORY_LIST = 'category_list'
export const CATEGORY_CHANGE_DESCRIPTION = 'category_change_description'
